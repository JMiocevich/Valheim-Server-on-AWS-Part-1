...
export function paginateListTaskDefinitionFamilies(config, input) {
    var additionalArguments = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        additionalArguments[_i - 2] = arguments[_i];
    }
    return __asyncGenerator(this, arguments, function paginateListTaskDefinitionFamilies_1() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    page = _a.sent();
                    return [3, 6];
                case 5: throw new Error("Invalid client, expected ECS | ECSClient");
